            ...
            <div className="container card col-md-6">
                ...
                <form className="form card-body" onSubmit={(e)=>handleForm(e)} id="room-form">
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-md-9">
                            <input type='file' accept="image/*" multiple onChange={()=>imageHandler()} name="image-1"/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <div className="col-md-3">
                        ...
                        <div className="col-md-9">
                            <input type='file' accept="image/*" multiple onChange={()=>imageHandler()} name="image-2"/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <div className="col-md-3">
                        ...
                        <div className="col-md-9">
                            <input type='file' accept="image/*" multiple onChange={()=>imageHandler()} name="image-3"/>
                        </div>
                    </div>
                    <div className="row mb-3">
